            ...
            <div class="col-lg-8">
                ...
                <div class="row mb-4" >
                    <div class="col-md-6">
                        ...
                        <h5 class="mt-2 text-secondary text-capitalize">intitule </h5>
                        <span class="mb-sm-20 d-block text-capitalize"><i class="fas fa-map-marker-alt text-primary font-12"></i> &nbsp;adresse</span>
                    </div>
                    <div class="col-md-6" style="text-align: end;" >
                        <div class="text-primary text-left h5 my-2 text-md-right">450 cfa</div>
                ...
                <div class="property-details">
                    <div class="bg-gray property-quantity px-4 pt-4 w-100">
                        <ul>
                            <li><span class="text-secondary">kkk</span> Sqft</li>
                            <li><span class="text-secondary">kkk</span> Bedroom</li>
                            <li><span class="text-secondary">kkk</span> Bathroom</li>
                            <li><span class="text-secondary">kkk</span> Balcony</li>
                            <li><span class="text-secondary">kkk</span> Hall</li>
                            <li><span class="text-secondary">kkk</span> Kitchen</li>
                        </ul>
                    </div>
                    ...
                    <div  class="table-striped font-14 pb-2">
                        <table class="w-100">
                            <tbody>
                                <tr>
                                    <td>BHK :</td>
                                    <td class="text-capitalize">kkk</td>
                                    <td>Property Type :</td>
                                    <td class="text-capitalize">kkk</td>
                                </tr>
                                <tr>
